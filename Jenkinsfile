pipeline {
    ...
    stages {
		...
		stage('Publish') {
			steps {
				script {
					nexusArtifactUploader artifacts: [[artifactId: 'gs-spring-boot', classifier: '', file: 'target/*.jar', type: 'jar']], credentialsId: '', groupId: 'org.springframework', nexusUrl: '10.0.1.153:8081/nexus/', nexusVersion: 'nexus2', protocol: 'http', repository: 'thirdparty', version: '2.14.9'
				}
